...
/**
 * This clas allows to create the piece number 6
 *
...
public class Piece6 {
	...
	/**
	 * This method allows to initialize the piece 6
	 * @param color the number for the color
	 */
	public Piece6(int color) {
   ...
   */
  public int[][] getPiece6Position(int position) {
    int[][] piece = null;
    piece = new int[4][4];
