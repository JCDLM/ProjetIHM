...
/**
 * This clas allows to create the piece number 3
 *
...
public class Piece3 {
	...
	/**
	 * This method allows to initialize the piece 3
	 * @param color the number for the color
	 */
	public Piece3(int color) {
   ...
   */
  public int[][] getPiece3Position(int position) {
    int[][] piece = null;
    piece = new int[3][3];
