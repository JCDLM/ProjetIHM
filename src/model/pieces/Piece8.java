...
/**
 * This clas allows to create the piece number 8
 *
...
public class Piece8 {
	...
	/**
	 * This method allows to initialize the piece 8
	 * @param color the number for the color
	 */
	public Piece8(int color) {
   ...
   */
  public int[][] getPiece8Position(int position) {
    int[][] piece = null;
    piece = new int[3][3];
