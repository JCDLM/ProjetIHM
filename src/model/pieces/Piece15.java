...
/**
 * This clas allows to create the piece number 15
 *
 * @author Ars Martin - Biancat Jean
 * @version 0.1.1
 */

public class Piece15 {

	private int color;

	/**
	 * This method allows to initialize the piece 15
	 * @param color the number for the color
	 */
	public Piece15(int color) {
   ...
   */
  public int[][] getPiece15Position(int position) {
    int[][] piece = null;
    piece = new int[3][3];
