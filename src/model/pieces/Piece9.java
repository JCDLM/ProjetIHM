...
/**
 * This clas allows to create the piece number 9
 *
...
public class Piece9 {
	...
	/**
	 * This method allows to initialize the piece 9
	 * @param color the number for the color
	 */
	public Piece9(int color) {
   ...
   */
  public int[][] getPiece9Position(int position) {
    int[][] piece = null;
    piece = new int[4][4];
