...
/**
 * This clas allows to create the piece number 17
 *
 * @author Ars Martin - Biancat Jean
 * @version 0.1.1
 */

public class Piece17 {

	private int color;

	/**
	 * This method allows to initialize the piece 17
	 * @param color the number for the color
	 */
	public Piece17(int color) {
   ...
   */
  public int[][] getPiece17Position(int position) {
    int[][] piece = null;
    piece = new int[3][3];
