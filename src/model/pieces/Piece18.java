...
/**
 * This clas allows to create the piece number 18
 *
 * @author Ars Martin - Biancat Jean
 * @version 0.1.1
 */

public class Piece18 {

	private int color;

	/**
	 * This method allows to initialize the piece 18
	 * @param color the number for the color
	 */
	public Piece18(int color) {
   ...
   */
  public int[][] getPiece18Position(int position) {
    int[][] piece = null;
    piece = new int[3][3];
