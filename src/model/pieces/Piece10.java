...
/**
 * This clas allows to create the piece number 10
 *
 * @author Ars Martin - Biancat Jean
 * @version 0.1.1
 */

public class Piece10 {

	private int color;

	/**
	 * This method allows to initialize the piece 10
	 * @param color the number for the color
	 */
	public Piece10(int color) {
   ...
   */
  public int[][] getPiece10Position(int position) {
    int[][] piece = null;
    piece = new int[3][3];
