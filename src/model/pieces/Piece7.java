...
/**
 * This clas allows to create the piece number 7
 *
...
public class Piece7 {
	...
	/**
	 * This method allows to initialize the piece 7
	 * @param color the number for the color
	 */
	public Piece7(int color) {
   ...
   */
  public int[][] getPiece7Position(int position) {
    int[][] piece = null;
    piece = new int[3][3];
